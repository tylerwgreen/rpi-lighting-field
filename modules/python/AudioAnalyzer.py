...
class AudioAnalyzer:
	...
	# WAVE FILES
	# waveFile = '0_16.wav' # single freq
	# waveFile = 'tone.wav' # freq sweep
	# waveFile = 'technologic.wav'
	# waveFile = 'technologic-real.wav'
	waveFile = 'drums-01.wav'
	# waveFile = '1k-octaves.wav'
	# waveFile = '440-octaves.wav'
	# waveFile = '440-stereo.wav' # 440 khz tone
	# waveFile = '440-mono.wav' # 440 khz tone
	# waveFile = '440-stereo-loud.wav'
	# waveFile = '440-mono-loud.wav'
	# waveFile = '440-mono-half-as-loud.wav' # 440 khz tone half as loud as 440-mono.wav
	# waveFile = '440-mono-quiet.wav' # 440 khz tone quieter than 440-mono.wav
	# waveFile = '440-mono-16-44-0db.wav' # 440 khz tone

	def __init__(self, nodeInterface, audioDir):
	...
	def readWav(self):
		...
		# if len(sys.argv) < 2:
			...
			# waveFile = 'assets/audio/' + self.waveFile
		# else:
			# waveFile = 'assets/audio/' + sys.argv[0]
		waveFile = self.audioDir + self.waveFile
